...
typedef tio_bool_t (*TIO_CB_CUSTOM_PUSH)(const char* message, size_t message_length, void* userdata);
...
typedef struct tio_handler_t {
    ...
    TIO_CB_ERR _cb_err;
    void* _cb_err_data;
    TIO_CB_CUSTOM_PUSH _cb_custom_push;
    void* _cb_custom_push_data;
    kii_t _kii;
    char* _http_buff;
...
void tio_handler_set_cb_push(tio_handler_t* handler, TIO_CB_CUSTOM_PUSH cb_custom_push, void* userdata);
