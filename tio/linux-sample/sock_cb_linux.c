...
khc_sock_code_t
    mqtt_cb_send(void* socket_context,
            const char* buffer,
            size_t length)
{
    socket_context_t* ctx = (socket_context_t*)socket_context;
...
khc_sock_code_t
    mqtt_cb_recv(void* socket_context,
            char* buffer,
            size_t length_to_read,
            size_t* out_actual_length)
{
...
khc_sock_code_t
    updater_cb_send(void* socket_context,
            const char* buffer,
            size_t length)
{
    socket_context_t* ctx = (socket_context_t*)socket_context;
...
khc_sock_code_t
    updater_cb_recv(void* socket_context,
            char* buffer,
            size_t length_to_read,
            size_t* out_actual_length)
{
...
khc_sock_code_t
    updater_cb_close(void* socket_context)
{
    socket_context_t* ctx = (socket_context_t*)socket_context;
    int ret = SSL_shutdown(ctx->ssl);
    if (ret != 1) {
