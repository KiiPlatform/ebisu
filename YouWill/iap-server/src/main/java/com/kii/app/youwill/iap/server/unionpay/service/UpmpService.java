package com.kii.app.youwill.iap.server.unionpay.service;

import com.kii.app.youwill.iap.server.unionpay.conf.UpmpConfig;
import com.kii.app.youwill.iap.server.unionpay.util.HttpUtil;
import com.kii.app.youwill.iap.server.unionpay.util.UpmpCore;
...
public class UpmpService{
	...
	public static String buildReq(Map<String, String> req) {
		...
		return UpmpCore.createLinkString(filteredReq, true, true);
	}
