...
#define HR_I2C_TX                   (HR_I2C_BASE_ADDR + 0x0C)
#define HR_I2C_RX                   (HR_I2C_BASE_ADDR + 0x10)
#define HR_I2C_CONFIG               (HR_I2C_BASE_ADDR + 0x14)
#define HR_I2C_STATUS               (HR_I2C_BASE_ADDR + 0x18)
