        ...
        char *buf, u32 buflen)
{
    ...
    if(skt_info->socket)
        ...
        err = tls_socket_udp_sendto(skt_info->local_port, &skt_info->remote_ip, skt_info->remote_port, buf, buflen);
...
tls_os_timer_t *default_sock_tmr = NULL;
static void hostif_default_socket_create_tmr()
{
    tls_os_status_t err;
